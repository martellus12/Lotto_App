...
mm_last5drawsLabel1 = tk.Label(mm_last5DrawsFrame, text = 'Last 5 Draws', bg = 'white')
mm_last5drawsLabel2 = tk.Label(mm_last5DrawsFrame, anchor=tk.W, bg = 'white')
mm_last5Date = tk.Label(mm_last5drawsLabel2, text = 'Date', bg = 'white')
mm_last1 = tk.Label(mm_last5drawsLabel2, text = '1', bg = 'white')
mm_last2 = tk.Label(mm_last5drawsLabel2, text = '2', bg = 'white')
mm_last3 = tk.Label(mm_last5drawsLabel2, text = '3', bg = 'white')
mm_last4 = tk.Label(mm_last5drawsLabel2, text = '4', bg = 'white')
mm_last5 = tk.Label(mm_last5drawsLabel2, text = '5', bg = 'white')
mm_lastMB = tk.Label(mm_last5drawsLabel2, text = 'MB', bg = 'white')
...
pb_mbLabel = tk.Label(pb_numFrame, text = 'PB', bg = 'white')
pb_last5drawsLabel1 = tk.Label(pb_last5DrawsFrame, text = 'Last 5 Draws')
...
pb_lastMB = tk.Label(pb_last5drawsLabel2, text = 'PB')
